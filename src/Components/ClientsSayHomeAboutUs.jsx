...
export default function ClientsSayHomeAboutUs() {
  return (
    <>
        ...
        <Swiper
                ...
                >
                    ...
                    <SwiperSlide>
                        <div className="">
                            <article className="quote-carly quote-carly-1 quote-carly-2">
                                <div class="quote-carly-text">
                                    <FaQuoteLeft className='quote-carly-icon quote-carly-icon2 '/>
                                    <div className="q">
                                ...
                                <div className="quote-carly-footer">
                                        <div className="unit unit-spacing-sm  unit-spacing-sm2 d-flex flex-column flex-md-row align-items-center">
